...
/* BINDTOOL_HEADER_FILE_HASH(8ba585c954587c35f939e57832205daf)                     */
/***********************************************************************************/
...
void bind_combined_usrp_receiver(py::module& m)
{
    ...
    py::class_<combined_usrp_receiver,
               gr::hier_block2,
               std::shared_ptr<combined_usrp_receiver>>(
        m, "combined_usrp_receiver", D(combined_usrp_receiver))
        ...
        .def("set_gain",
             &combined_usrp_receiver::set_gain,
             py::arg("gain"),
             D(combined_usrp_receiver, set_gain))


        .def("set_center_freq",
             &combined_usrp_receiver::set_center_freq,
             py::arg("tune_request"),
             D(combined_usrp_receiver, set_center_freq))


        .def("set_antenna",
             &combined_usrp_receiver::set_antenna,
             py::arg("ant"),
